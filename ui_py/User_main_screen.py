...
#
# Created: Sat Jun  1 17:43:03 2019
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 648, 517))
        ...
        self.verticalLayout.addWidget(self.pushButton_commit_sen_method)
        ...
        self.verticalLayout.addWidget(self.radioButton_search_user_profile)
        ...
        self.verticalLayout.addWidget(self.radioButton_search__keyword)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 628, 69))
...
"color: rgb(0,0,0);")
        ...
        self.tableWidget_requested_job = QtWidgets.QTableWidget(self.scrollAreaWidgetContents)
