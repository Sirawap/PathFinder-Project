...
"}")
        ...
        self.horizontalLayout_7.addWidget(self.radioButton_Show_all)
        ...
        self.horizontalLayout_7.addWidget(self.radioButton_search__keyword)
        ...
        self.horizontalLayout_7.addWidget(self.radioButton_search_user_profile)
